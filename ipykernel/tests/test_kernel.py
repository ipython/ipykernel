...
def test_autocomplete_over_control():
    ...
    with new_kernel() as kc:
        ...
        sleep_msg_id = kc.execute("import time; time.sleep(5)")
        ...
        for i in range(N):
            content = dict(code=code, cursor_pos=len(code))
        ...
        shell_replies = [get_reply(kc, sleep_msg_id)]
        # shell_replies = []
